...
export function SpeakerCard({ speaker, onTap }: SpeakerCardProps) {
  ...
  return (
    ...
    >
      <div className="relative w-24 h-24 rounded-full bg-el-gray-light overflow-visible mb-3 shrink-0">
        ...
        {isMvp && (
          <img
            ...
            alt="Microsoft MVP"
            className="absolute -bottom-1 -right-1 w-7 h-7 rounded-full bg-white p-0.5 shadow-md"
          />
        )}
      </div>
